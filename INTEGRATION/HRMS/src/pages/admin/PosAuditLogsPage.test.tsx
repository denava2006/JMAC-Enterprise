...
const branches: Branch[] = [
  ...
  { id: 'closed', name: 'Closed Depot', address: null, phone: null, latitude: null, longitude: null, is_active: false, show_on_landing: false, image_path: null, display_order: 0, created_at: '', updated_at: '' },
]
